 ...
 * @LastEditTime: 2019-09-04 10:35:07
...
import { Distribute_Search_list, Distribute_Status_List,Order_Type_list } from "@/utils/ENUM";
...
export default {
  ...
  data() {
    return {
      ...
      rowCheckAll: false,
      rowChoosed: [],
      rowList: Distribute_Search_list.filter(res => {
        return (
