 ...
 * @LastEditTime: 2019-09-04 10:39:55
  ...
  <div>
    <el-row>
      <el-form
        ...
        label-width="80px"
      >
        <!-- <el-form-item label="商户" v-if="$store.state.user.roleType=='carrier'" prop="carrierInfo">
            <el-select class="w100p" v-model="searchForm.merchantId" filterable placeholder="请选择商户">
              <el-option
        ...
        <el-form-item label-width="0" prop="" class="multiple_search_box">
          <el-select
            ...
            placeholder="请选择"
          >
            <el-option label="预约时间" value="0"></el-option>
            <el-option label="期望提货时间" value="1"></el-option>
            <el-option label="期望完成时间" value="2"></el-option>
          </el-select>
          <el-date-picker
            class="multiple_date"
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.params.waybillNo) {
      this.searchForm.waybillNo = this.$route.params.waybillNo;
    }
